...
public class Grid_Line_Saparator extends AppCompatImageView {
    ...
    public Grid_Line_Saparator(Context context, @Nullable AttributeSet attributeSet, int i) {
    ...
    public Grid_Line_Saparator(Context context) {
        super(context);
        this.isInCenterX = false;
        this.isInCenterY = false;
        this.bitmapPoints = new float[8];
    ...
    private void initialization(Context context) {
        ...
        this.paint.setStrokeWidth((float) Glide_Image_Utils.convertDpToPx(context, 2.0f));
    ...
    public Grid_Line_Saparator(Context context, @Nullable AttributeSet attributeSet) {
