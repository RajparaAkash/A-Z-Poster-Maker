package com.letsmake.atoz.design.utils;
...
public class AspectRatioLayout extends FrameLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Ad_AspectRatioLayout, defStyleAttr, defStyleRes);
        widthRatio = a.getFloat(R.styleable.Ad_AspectRatioLayout_arl_widthRatio, 1);
        heightRatio = a.getFloat(R.styleable.Ad_AspectRatioLayout_arl_heightRatio, 1);
        a.recycle();
    }
