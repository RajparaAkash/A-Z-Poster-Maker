...
public class ViewElementInfo {
    ...
    private String RES_ID, FIELD_THREE = "", FIELD_TWO = "", COLORTYPE, FIELD_FOUR = "", STKR_PATH = "", TYPE = "";
    private Uri RES_URI;
    private float Y_ROTATION, ROTATION, POS_X, POS_Y;
    private int HEIGHT, ORDER, STC_COLOR, COMP_ID, FIELD_ONE = 0, STC_HUE, STC_OPACITY, TEMPLATE_ID, WIDTH, XRotateProg, YRotateProg, ZRotateProg, ScaleProg;


    public ViewElementInfo() {
    ...
    public ViewElementInfo(int i, float f, float f2, int i2, int i3, float f3, float f4, String str, String str2, int i4, int i5, int i6, int i7, int i8, int i9, int i10, String str3, String str4, int i11, int i12, String str5, String str6, String str7, Uri uri, Bitmap bitmap) {
        this.TEMPLATE_ID = i;
        this.POS_X = f;
        this.POS_Y = f2;
        this.WIDTH = i2;
