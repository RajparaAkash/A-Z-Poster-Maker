...
public class RV_Item_Click_Listener implements OnItemTouchListener {

    private GestureDetector mGestureDetector;
    private OnItemClickListener mListener;

    public RV_Item_Click_Listener(Context context, OnItemClickListener onItemClickListener) {
